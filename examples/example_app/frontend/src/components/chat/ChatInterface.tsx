...
import { Send, Square, Bot, User, Menu, X, Trash2 } from "lucide-react"
        ...
        >
          ...
          {toolCall.args && (
            <div className="mt-2 rounded bg-muted p-2 font-mono text-xs">
              <pre className="overflow-x-auto">{toolCall.args}</pre>
            </div>
          )}
          {toolCall.result && toolCall.status === "complete" && (
            <div className="mt-2 rounded bg-muted p-2 font-mono text-xs">
              <pre className="overflow-x-auto">{toolCall.result}</pre>
            </div>
          )}
        </div>
      ))}
