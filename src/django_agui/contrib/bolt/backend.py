...
class BoltBackend:
    """Backend helper for wiring AG-UI endpoints into Django Bolt."""

    route_name_prefix = "agui-bolt"

    def get_api_class(self):
        """Return the Bolt API class."""
        try:
    ...
    def get_endpoint(
        ...
        *,
        ...
        """Return the endpoint callable registered on the Bolt API."""
        return create_bolt_endpoint(
            run_agent=run_agent,
    ...
    def create_api(
        ...
        **kwargs: Any,
        ...
        """Create a BoltAPI instance with one AG-UI endpoint at ``/``."""
    ...
    def get_urlpatterns(
        ...
        **kwargs: Any,
        ...
        """Build Django URL patterns for a Bolt AG-UI endpoint."""
